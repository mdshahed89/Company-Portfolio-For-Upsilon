...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_0act8td', 'template_alj4q3b', form.current, {
        publicKey: 'ONG3Ul8RdLXorbsaN',
      })
      .then(
        () => {
          console.log('SUCCESS!');
  ...
  return (
    <div className='w-full h-[100vh] relative z-0  '>
      ...
      <div className='absolute top-0 w-full h-full flex-col lg:flex-row z-10 flex items-center justify-center gap-[5rem] lg:gap-[10rem] px-[5%] lg:px-[10%]'>
        <div>
          <Fade direction='left'>
          <h3 className='text-whit font-BankGothic text-2xl lg:text-4xl text-white '>UPSILON ABM</h3>
          </Fade>
        </div>
